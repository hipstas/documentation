...
<html>
  <body>
    ...
    <p>You can use spreadsheet programs like Excel or Google sheets that export .tsv, .csv, or .xlsx files to create and organize annotations for AudiAnnotate. To do so:</p>
      <ol>
        <li>Create a blank spreadsheet or use <a href="https://docs.google.com/spreadsheets/d/1meV7EHU354IqG8RtnoPNXVRqdpDrYpQQSj3LNEy1VNY/copy">this template</a>. (Upon opening this link, you will be prompted to make a copy of this template for your own use.)</li>
        <br>
